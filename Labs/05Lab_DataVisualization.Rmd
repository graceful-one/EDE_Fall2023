...
months_peterpaul <-factor(PeterPaul.chem.nutrients$month,levels = 1:12,labels=month.abb)

#Try again: Plot how many Lake observations occur each month
ggplot(PeterPaul.chem.nutrients, aes(x=months_peterpaul)) +
  geom_bar()
...
ggplot(filter(PeterPaul.chem.nutrients,depth==0),aes(x=daynum,y=temperature_C)) +
  geom_point()
