...
# Working directory should be set to the base folder for the Environmental Data Analytics Course repository, i.e., the folder that houses the R Project file. working directory when going is ususally the project file, may change when knitting 
...
# 1. 
lake_chem <- read.csv(file = here('Data','Raw','NTL-LTER_Lake_ChemistryPhysics_Raw.csv'),stringsAsFactors = T
)
