...
visual aspecs, has preset themes 
...
O3plot3 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone)) +
  theme_light()#very similar to black and white 
print(O3plot3)
...
```{r, fig.height = 3, fig.width = 4, warning = FALSE}
#set up your own theme and save it. 
...
theme_set(mytheme) # set to be the defalt going forward in the code
...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  geom_hline(yintercept = 50, lty = 2) + #horizontal line at 50
  geom_hline(yintercept = 100, lty = 2) + #horizontal line at 100
  geom_point(alpha = 0.5, size = 1.5) + #
  #next few lines add text to the plot, just tell it where
