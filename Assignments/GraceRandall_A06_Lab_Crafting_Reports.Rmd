...
------------------------------------------------------------------------
```{r echo=FALSE, fig.height=4, fig.width=6, warning=FALSE, fig.cap= "Monthly Ozone, 2018"}
ozone_2018 <- ggplot(data=filter(epa_data, Year==2018),
...
```{r echo=FALSE, fig.height=4, fig.width=6, warning=FALSE, fig.cap= "Monthly Ozone, 2019"}
ozone_2019 <- ggplot(data=filter(epa_data, Year==2019),
                     aes(x=factor(Month, levels=1:12, labels=month.abb)
                         ,y=Ozone))+
...
## Git Repository
https://github.com/graceful-one/EDE_Fall2023
